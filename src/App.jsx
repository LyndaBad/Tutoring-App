...
const COURSES=[
  ...
  {id:"igcse-math",g:"igcse",sub:"math",icon:"∑",col:T.gr,pale:T.gra,rate:{gbp:40,usd:54},hours:{full:36,half:18,q:9},lessons:16,title:"IGCSE Mathematics",curr:"International GCSE",board:"Cambridge (CIE 0580) · Edexcel (4MA1)",desc:"Full IGCSE Maths (Extended): number, algebra, geometry, trigonometry, statistics and probability for grade 7–9 / A*.",assess:["Baseline","Mid-course","Final"],outcomes:["Extended tier coverage","Exam technique for CIE & Edexcel","Target: 7–9 / A*"],eq:{l:"Quadratic Formula",d:"x=(−b±√(b²−4ac))/2a"}},
  {id:"igcse-chem",g:"igcse",sub:"chem",icon:"⚗",col:T.gr,pale:T.gra,rate:{gbp:40,usd:54},hours:{full:30,half:15,q:7},lessons:13,title:"IGCSE Chemistry",curr:"International GCSE",board:"Cambridge (CIE 0620) · Edexcel (4CH1)",desc:"Complete IGCSE Chemistry with practical-skills and six-mark question technique.",assess:["Baseline","Mid-course","Final"],outcomes:["Full IGCSE Chem","Practical paper technique","Target: 7–9 / A*"],eq:{l:"Moles",d:"n = mass / Mᵣ"}},
  {id:"ial-math",g:"ial",sub:"math",icon:"∑",col:T.rd,pale:T.rda,rate:{gbp:48,usd:64},hours:{full:45,half:22,q:11},lessons:19,title:"International A-Level Mathematics",curr:"International A-Level (IAL)",board:"Edexcel IAL · Cambridge International AS/A",desc:"Full IAL Maths: Pure (P1–P4) plus Statistics and Mechanics units, with A* exam technique.",assess:["Baseline","Mid-course","Final"],outcomes:["Full IAL units","Unit-based exam technique","Target: A/A*"],eq:{l:"Integration by Parts",d:"∫u dv = uv − ∫v du"}},
  {id:"ial-chem",g:"ial",sub:"chem",icon:"⚗",col:T.rd,pale:T.rda,rate:{gbp:48,usd:64},hours:{full:45,half:22,q:11},lessons:14,title:"International A-Level Chemistry",curr:"International A-Level (IAL)",board:"Edexcel IAL · Cambridge International AS/A",desc:"Full IAL Chemistry across all units — physical, inorganic and organic with practical endorsement support.",assess:["Baseline","Mid-course","Final"],outcomes:["All IAL units","Organic mechanisms","Target: A/A*"],eq:{l:"Arrhenius",d:"k=A·e^(−Eₐ/RT)"}},
