...
-- NOTE: lessons RLS policy added after enrollments table (below)
...
-- NOTE: assessments RLS policy added after enrollments table (below)
...
-- ── DEFERRED RLS (requires enrollments to exist) ──────────────────────
